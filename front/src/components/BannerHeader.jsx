...
const BannerHeader = ({ title, className = "" }) => (
  ...
  >
    <div className="absolute inset-0 flex items-center justify-center">
      ...
      <div
        className="w-full h-24 rounded-[2.5rem] border-4 border-[#bfa76a] bg-[#f7e6b6] shadow-lg flex items-center justify-center"
        style={{ boxShadow: "0 4px 24px #c2b28055" }}
      ></div>
    </div>
    <h1
      className="text-3xl md:text-4xl font-bold text-[#7c5c2b] drop-shadow z-10"
      style={{ fontFamily: "Jua, sans-serif", letterSpacing: "0.04em" }}
    >
      {title}
    </h1>
  </div>
